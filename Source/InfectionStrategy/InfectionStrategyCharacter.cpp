...
void AInfectionStrategyCharacter::Tick(float DeltaSeconds)
{
    Super::Tick(DeltaSeconds);
}

void AInfectionStrategyCharacter::BeginPlay()
{
	Super::BeginPlay();
	FVector locationOffset = GetActorLocation();
	locationOffset *= FVector::DownVector;
